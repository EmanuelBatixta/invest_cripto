...
function Login() {
    ...
    function onSubmit(event){
        ...
        doLogin(email, password)
            ...
            .catch((err) => {
                setError(err || 'Um erro inesperado ocorreu')
        })
    }
                    ...
                    <div className="col-12 d-flex align-items-center justify-content-center">
                        <div className="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            <div className="text-center">
                                <img src="/img/favicon/mstile-150x150.png" alt="Cripto Ivest" width={64}/>
                            </div>
                            ...
                            <div className="form-group mb-4">
                                ...
                                <div className="form-group">
                                    ...
                                    <div className="d-flex justify-content-between align-items-top mb-4">
                                        ...
                                        <div><a href="./forgot-password.html" className="small text-right">Esqueceu a senha?</a></div>
                                    </div>
                                    <div className="d-grid">
                                        <button type="submit" className="btn btn-gray-800">Login</button>
                                    </div>
                                    { error ? <div className="alert alert-danger mt-2"> {error} </div> : <React.Fragment/> }
                                </div>
                            </form>
                        </div>
                   </div>
